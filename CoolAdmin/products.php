        ...
        <aside class="menu-sidebar2">
            ...
            <div class="menu-sidebar2__content js-scrollbar1">
                <div class="account2">
                    ...
                    <a href="products.php">Administrator</a>
                </div>
                          ...
                          <tbody>
                            ...
                            if($result){
                              while($res = mysqli_fetch_array($result)) { 
                                echo "<tr>";
                            ?>    
                                 <!-- <td><?php echo $res['prod_serial'];?></td> -->
                                 <td> <img width="150" height="100" src="../uploads/<?php echo $res['prod_pic1'];?>" alt=""/></td>  
                                 ...
                                 <td><?php echo $res['supplier'];?></td>
                                    ...
                                    <td>
                                    <a class="btn btn-sm btn-outline-warning btn-block" href="addQty.php?prod_id=<?php echo $res['prod_id'] ?>">Add Qty</a>
                                    <a class="btn btn-sm btn-outline-primary btn-block" href="editProduct.php?prod_id=<?php echo $res['prod_id'] ?>">Edit</a> 
                                    <a class="btn btn-sm btn-outline-danger btn-block" href="deleteProduct.php?prod_id=<?php echo $res['prod_id'] ?>" onClick="return confirm('Are you sure you want to delete?')">Delete</a> 

                                    <a class="btn btn-sm btn-outline-success btn-block" href="../pages/admin_product_details.php?prod_id=<?php echo $res['prod_id'] ?>">View</a> 
                                    </td>  
                            <?php
                             echo "</tr>";     
                              }
