  ...
  <div class="page-wrapper">
            ...
            <div class="card mb-3">
                ...
                ?>  
                          ...
                          <tbody>
                            ...
                            if($result){
                              while($res = mysqli_fetch_array($result)) {  
                                ...
                                $query3=mysqli_query($dbconn,"SELECT * FROM `order` WHERE `order_id`='$order_id' && `status`='Delivered'") or die (mysqli_error());
                             ...
                             ?>
                              ...
                              <td><br><span style="background: #2eec71; color: white"><?php echo $row3['status'];?></span></td>     
                      ...
                      <div class="row" style="margin-left: 50px">
                        <h3>Total Payment Collected: </h3> <u style="margin-left: 10px; font-size: 20px;">&#8369;<?php echo $row3['totalprice'];?></u>
                      </div>
