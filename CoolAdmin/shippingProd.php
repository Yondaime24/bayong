...
<head>
    ...
    <title>BAYONG | Delivering Products</title>
                                    ...
                                    <div class="au-breadcrumb-left">
                                        ...
                                        <ul class="list-unstyled list-inline au-breadcrumb__list">
                                            <li class="list-inline-item active">
                                                <a href="customer.php">Shipping</a>
                                            </li>
            ...
            <section class="statistic">
              ...
              <div class="card mb-3">
                    ...
                    <?php
                          ...
                          $query = "SELECT * FROM `order` WHERE `status` = 'Shipping' ORDER BY `order_date` DESC";
                            ...
                            if($result){
                              while($res = mysqli_fetch_array($result)) {     
                                echo "<tr>";
                                  ...
                                  echo "<td> <span style=\"background: #3498db; color: white\">".$res['status']."</span></td>";
                                  echo "<td>
                                    <a class=\"btn btn-sm btn-outline-info btn-block\" href=\"viewShipping.php?order_id=$res[order_id]&&user_id=$res[user_id]\">View</a>
