                                    ...
                                    <div class="au-breadcrumb-left">
                                        ...
                                        <ul class="list-unstyled list-inline au-breadcrumb__list">
                                            <li class="list-inline-item active">
                                                <a href="customer.php">Delivered Products</a>
                                            </li>
                    ...
                    <div class="card-body">
                      <div class="table-responsive">
                       <?php
                          ...
                          $query = "SELECT * FROM `order` WHERE `status` = 'Delivered' ORDER BY `order_date` DESC";
                            ...
                            if($result){
                              while($res = mysqli_fetch_array($result)) {     
                                echo "<tr>";
                                  ...
                                  echo "<td><span style=\"background: #2ecc71; color: white\">".$res['status']."</span></td>";
                                  echo "<td>
                                    <a class=\"btn btn-sm btn-outline-success btn-block\" href=\"viewDelivered.php?user_id=$res[user_id]&&order_id=$res[order_id]\">View</a>
