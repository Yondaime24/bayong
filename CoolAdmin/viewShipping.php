...
if(isset($_POST['deliverBtn'])){
    ...
    $message = $_POST['message'];
        ...
        if($query_run==1){
         ...
         $query2="UPDATE `order_details` SET `status`='Delivered' WHERE order_id='$order_id'";
  ...
  <div class="page-wrapper">
                          ...
                          <tbody>
                            ...
                            if($result){
                              while($res = mysqli_fetch_array($result)) {  
                                ...
                                $query3=mysqli_query($dbconn,"SELECT * FROM `order` WHERE `order_id`='$order_id' && `status`='Shipping'") or die (mysqli_error());
    ...
    <!-- modal medium -->
        ...
        <form id="packaging" action="viewShipping.php?order_id=<?php echo $order_id ?>&&user_id=<?php echo $user_id?>" method="post">
            ...
            <center>
              <span><b>Order Successfully Delivered</b></span>
            </center>
