...
<head>
    ...
    <title>BAYONG | Packaged Products</title>
                                    ...
                                    <div class="au-breadcrumb-left">
                                        ...
                                        <ul class="list-unstyled list-inline au-breadcrumb__list">
                                            <li class="list-inline-item active">
                                                <a href="customer.php">Packaging</a>
                                            </li>
            ...
            <section class="statistic">
              ...
              <div class="card mb-3">
                    ...
                    <?php
                          ...
                          $query = "SELECT * FROM `order` WHERE `status` = 'Packaged' ORDER BY `order_date` DESC";
                            ...
                            if($result){
                              while($res = mysqli_fetch_array($result)) {     
                                echo "<tr>";
                                  ...
                                  echo "<td> <span style=\"background: orange; color: white\">".$res['status']."</span></td>";
                                  echo "<td>
                                    <a class=\"btn btn-sm btn-outline-warning btn-block\" href=\"viewPackaging.php?order_id=$res[order_id]&&user_id=$res[user_id]\">View</a>
