...
<body class="index-page sidebar-collapse">
    ...
    <div class="wrapper">
        <div class="page-header clear-filter" filter-color="orange">
            <div class="page-header-image" data-parallax="true" style="background-image: url('./assets/img/logos.jpeg');">
...
?>   
    <div class="row-sm-3" style="display: inline-block; margin-left: 50px;">
        <div class="thumbnail">
