...
$query = "INSERT INTO `order` (user_id, track_num, firstname, middlename, lastname, email, contact, shipping_add, order_date, `status`, totalprice, tax) 
  ...
  $order = $dbconn->insert_id;

 mysqli_query($dbconn,"UPDATE order_details SET order_id='$order' WHERE user_id='$user_id' AND order_id=''")or die(mysqli_error());
...
?>
        ...
        <h3>Delivery process time, minimum of two(2) days and maximum of three(3) working days.</h3><br>
        <h5>Bayong Inc.</h5>
...
<footer class="footer" data-background-color="black">
            <div class="container">
                ...
                <div class="copyright">
                    ...
                    </script>, Designed by Layca Sequina                </div>
            </div>
        </footer>
    </div>
</body>
