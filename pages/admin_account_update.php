...
{   
    ...
    if(empty($fname) || empty($lname) || empty($email) || empty($uname) || empty($pword)) {    
        ...
        header("Location: ../CoolAdmin/index2.php");
        }
        ...
        <div class="main">
            <div class="section section-basic">
                <div class="container">
                      ...
                      <hr color="orange">
                      <a href='../CoolAdmin/index2.php' class='btn btn-warning btn-round'>Back</a>
                <br>
                <div class="col-md-12">
                  ...
                  <div class="panel-body">
                    <form action="admin_account_update.php" method="post">
                        <div class="form group">
                            ...
                            <input type="password" class="form-control" id="password" name="password" value="<?php echo $pword;?>" disabled>
