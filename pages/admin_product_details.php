...
<head>
    ...
    <title>BAYONG | View Product</title>
...
<div class="main">
    ...
    <div class="section" id="carousel">
        <div class="container">
            ...
            <a class="btn btn-primary btn-round" href="../CoolAdmin/index2.php"><i class="now-ui-icons arrows-1_minimal-left"></i> &nbsp Back to Home</a>
            <hr color="orange">
            <div class="col-md-12">
...
?>      
 ...
 <footer class="footer" data-background-color="black">
            <div class="container">
                <div class="copyright">
                    Copyright © 2021 Bayong. All rights reserved.
                </div>
            </div>
        </footer>
    </div>
