...
<body class="index-page sidebar-collapse">
    ...
    <div class="wrapper">
        <div class="page-header clear-filter" filter-color="orange">
            <div class="page-header-image" data-parallax="true" style="background-image: url('../assets/img/ironman.jpeg');">
                    ...
                    ?>   
                        <div class="row-sm-3">
                            <div class="thumbnail">
                                ...
                                <?php endif; ?>
                            <div class="caption">
                              <b><?php echo $res['prod_name'];?></b>
                              <h6><a class="btn btn-success btn-round" title="Click for more details!" href="admin_product_details.php?prod_id=<?php echo $res['prod_id'];?>"><i class="now-ui-icons gestures_tap-01"></i>View</a><medium class="pull-left">Php<?php echo $res['prod_price']; ?></medium></h6>
                            </div>
