                                            ...
                                            while($res = mysqli_fetch_array($result)) {     
                                              echo "<tr>";
                                                ...
                                                if ($res['status']=='Pending') {
                                                   ...
                                                   echo "<td><a class=\"btn btn-success\" style=\"color: white\" onclick=\"return confirm('Are you sure that this has been delivered?')\" href=\"delivered.php?order_id=$res[order_id]\">Delivered</a></td>";
                                                }else{
                                                    echo "<td> <span style=\"background: #2ecc71; color: white\">".$res['status']."</span> </td>";
                                                    echo "<td><i class=\"now-ui-icons loader_gear\"></i></td>";
                                                }
